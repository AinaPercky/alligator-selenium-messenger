...
def get_message_from_ai(message_param, is_welcome_message=False, site_url=None, site_name=None):
    ...
    prompt = os.getenv("WELCOME_PROMPT", "")
    ...
    if is_welcome_message:
        # Prompt spécifique pour un message de bienvenue en malgache
        full_prompt = f"Génère un message de bienvenue ou de salutation. {prompt}"
    else:
        # Prompt standard pour les réponses aux messages reçus
